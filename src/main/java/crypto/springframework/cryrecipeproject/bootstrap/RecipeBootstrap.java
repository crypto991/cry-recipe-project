package crypto.springframework.cryrecipeproject.bootstrap;

import crypto.springframework.cryrecipeproject.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        //VERY REDUDENT - COULD ADD HELPER METHOD, AND MAKE THIS SIMPLER
